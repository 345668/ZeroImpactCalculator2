        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
          <div className="flex-1 text-left animate-slide-up">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight text-white">
              ...
              <span className="text-green-200">Carbon Credits</span>
            </h1>
            ...
            <Button
              size="lg"
              variant="secondary"
              className="px-8 py-6 text-lg font-medium bg-white hover:bg-white/90 text-primary transition-all duration-300 group"
              onClick={() => {
          ...
          <div className="flex-1 flex justify-center lg:justify-end animate-slide-down">
            <div className="rounded-3xl p-8 sm:p-12 border border-white/10 bg-white/5 backdrop-blur-sm shadow-xl">
              <div className="w-full h-full min-h-[300px] flex items-center justify-center relative group">
                <div className="absolute inset-0 bg-gradient-to-br from-green-500/20 to-blue-500/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
